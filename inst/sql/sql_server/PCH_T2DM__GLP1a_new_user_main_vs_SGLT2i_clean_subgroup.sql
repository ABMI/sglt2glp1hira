...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4324124)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4324124)
  and c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4155963)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4155963)
  and c.invalid_reason is null
...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4283892,4081578,2725289,4106548,2725227,4284104,4063237,4148030,4184832,4336464,4305852,43527998,4006788,4283892,4020213,37017419)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4283892,4081578,2725289,4106548,2725227,4284104,4063237,4148030,4184832,4336464,4305852,43527998,4006788,4283892,4020213,37017419)
  and c.invalid_reason is null
...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (372924,375557,443454,441874,4112026,4319331,4111710)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (372924,375557,443454,441874,4112026,4319331,4111710)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4043732,4046362,764819,42535689,764818,42535680,42535678,42535682,42535685,765694,35621734)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4043732,4046362,764819,42535689,764818,42535680,42535678,42535682,42535685,765694,35621734)
  and c.invalid_reason is null
...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (198185,193782,46271022)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (198185,193782,46271022)
  and c.invalid_reason is null
...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44785831,45774754,1123740,715887,715760,43534751,1588671,1123890,44785829,45774751,793293,43009020,1123609,44506754,40170911,1501756,1123633,1583722,1123739)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44785831,45774754,1123740,715887,715760,43534751,1588671,1123890,44785829,45774751,793293,43009020,1123609,44506754,40170911,1501756,1123633,1583722,1123739)
  and c.invalid_reason is null
...
into #CodeSetData_40
FROM [CDMPv535_ABMI].[dbo].DRUG_EXPOSURE de
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 40));
---------------------------------------------------------
UPDATE #CodeSetData_40
SET drug_exposure_end_date =
case
when drug_source_value IN ('670801031', '670801051') THEN dateadd(day, quantity*7-1, drug_exposure_start_date)
...
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 41))
) C
...
(
  ...
  (
    ...
    (
      --cteEndDates
      select PERSON_ID, DATEADD(day,-1 * 30,EVENT_DATE) as END_DATE -- unpad the end date by 180
      FROM
      (
...
TRUNCATE TABLE #CodeSetData_40;
DROP TABLE #CodeSetData_40;
