...
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 38));
---------------------------------------------------------
UPDATE #CodeSetData_38
...
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 39))
) C
...
TRUNCATE TABLE #CodeSetData_38;
DROP TABLE #CodeSetData_38;
